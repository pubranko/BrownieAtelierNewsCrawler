...
# cron -> A cron expression of the format '{second} {minute} {hour} {day} {month} {day of week}' to specify
# the schedule.
#       "schedule": "20 3 3 7 1 *"
# For a `TimerTrigger` to work, you provide a schedule in the form of a [cron
...
# This, in plain text, means: "When seconds is equal to 0, minutes is divisible by 5, for any hour, day of the
# month, month, day of the week, or year".
...
deployment = Deployment.build_from_flow(
    ...
    version="1.1",
    tags=["demo"],
    parameters={"scraper_info_by_domain_files": ["nikkei_com.json"]},
    apply=True,
