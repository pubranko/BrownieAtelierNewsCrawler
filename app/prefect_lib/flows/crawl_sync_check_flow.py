...
def crawl_sync_check_flow(
    ...
    if state.is_completed():
        ...
        try:
            ...
            response_sync_list, response_async_list, response_async_domain_aggregate = sync_check_crawler_response_task(
                mongo, domain, start_time_from, start_time_to)

            # crawler_responseとnews_clip_masterが同期しているかチェックする。
            master_sync_list, master_async_list, master_async_domain_aggregate = sync_check_news_clip_master_task(
